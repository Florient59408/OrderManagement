...
INTO article_group (group_id, title) VALUES (6, 'clothing accessoire')
...
INSERT ALL
INTO employees(name, profile) VALUES ('Paul', utl_raw.cast_to_raw('E:\cours\PAM2\ProgrammationSQL\orders\Datas\user_40px.png'))
INTO employees(name, profile) VALUES ('Jean', utl_raw.cast_to_raw('E:\cours\PAM2\ProgrammationSQL\orders\Datas\user_40px.png'))
INTO employees(name, profile) VALUES ('Louis', utl_raw.cast_to_raw('E:\cours\PAM2\ProgrammationSQL\orders\Datas\user_40px.png'))
SELECT * FROM DUAL;
...
INSERT ALL
INTO group_voucher(group_id, voucher_id, start_date, end_date) VALUES(2, 1, SYSDATE, TO_DATE('09-12-2022', 'DD-MM-YYYY'))
INTO group_voucher(group_id, voucher_id, start_date, end_date) VALUES(1, 2, SYSDATE, TO_DATE('31-12-2022', 'DD-MM-YYYY'))
INTO group_voucher(group_id, voucher_id, start_date, end_date) VALUES(8, 3, SYSDATE, TO_DATE('07-03-2022', 'DD-MM-YYYY'))
SELECT * FROM DUAL;
...
INSERT ALL
INTO services(service_id,title,type,percentage)VALUES('jabra evolve_WS','Warranty','percentage',0.5)
SELECT * FROM DUAL;
INSERT ALL
INTO Warranties(title, duration, service_id)VALUES('warranty on article jabra evolve',45,'jabra evolve_WS')
SELECT * FROM DUAL;
...
INSERT ALL 
INTO clients(name, phone, profile) VALUES ('MANFO JIENGAP', 681410728, utl_raw.cast_to_raw('E:\cours\PAM2\ProgrammationSQL\orders\Datas\123.jpg'))
SELECT * FROM DUAL;
...
(   article_name, 
    article_description,
    group_id,
    class, price)VALUES('VENUS SQ', 'VENUS SQ white/gold', 7,'very small', 50000);
...
(   article_name, 
    article_description,
    group_id,
    class, price)VALUES('VENUS SQ', 'VENUS SQ grey', 7,'very small', 50000);
INSERT INTO article_service(article_id, service_id) VALUES (article_id_seq.currval, 'VENUS_SQ_WS');
INSERT INTO list_price(price, article_id, client_id) VALUES(30000, article_id_seq.currval, client_id_seq.currval);
...
(   article_name, 
    article_description,
    group_id,
    class, price)VALUES('VENUS SQ', 'VENUS SQ music white/gold', 7,'very small', 50000);
INSERT INTO article_service(article_id, service_id) VALUES (article_id_seq.currval, 'VENUS_SQ_WS');
INSERT INTO list_price(price, article_id, client_id) VALUES(30000, article_id_seq.currval, client_id_seq.currval);
...
INSERT INTO article_service(article_id, service_id) VALUES(article_id_seq.currval, 'iphone_WS');
INSERT INTO list_price(price, article_id, client_id) VALUES(295000, article_id_seq.currval, client_id_seq.currval);
...
insert into sound_purchase VALUES('SP01', 'sound purchase for computers', 2);
insert into sound_purchase_client VALUES('SP01', 1, 500000);
--update sound_purchase_client set amount = 600000 where client_id = 1 and sound_purchase_id = 'SP01';


Prompt ******  Populating CLIENTS table ....
INSERT ALL 
INTO clients(name, phone)VALUES('tedongmo gangnimaze', 658124545)
SELECT * FROM DUAL;
...
group_id,
class,
price)VALUES('jabra evolve','couleur blanche',9,'small',95000);
INSERT INTO article_service(article_id, service_id)VALUES(article_id_seq.currval,'jabra evolve_WS');
INSERT INTO list_price(price, article_id, client_id) VALUES(80000, article_id_seq.currval, client_id_seq.currval);
...
group_id,
class,
price)VALUES('jabra evolve','couleur rouge',9,'small',95000);
INSERT INTO article_service(article_id, service_id)VALUES(article_id_seq.currval,'jabra evolve_WS');
INSERT INTO list_price(price, article_id, client_id) VALUES(80000, article_id_seq.currval, client_id_seq.currval);
...
group_id,
class,
price)VALUES('jabra evolve','couleur noir',9,'small',80000);
INSERT INTO article_service(article_id, service_id)VALUES(article_id_seq.currval,'jabra evolve_WS');
INSERT INTO list_price(price, article_id, client_id) VALUES(70000, article_id_seq.currval, client_id_seq.currval);
...
INSERT ALL
INTO article_group (group_id, title) VALUES (11, 'headphones')
SELECT * FROM dual;

Prompt ******  Populating LOCATIONS table ....

INSERT INTO locations(latitude, longitude, city_name) VALUES(4.06, 9.6, 'Douala');

Prompt ******  Populating CLIENTS table ....

INSERT INTO clients(name, phone) VALUES ('Essono junior', 674053983);

Prompt ******  Populating ADDRESS table ....

INSERT INTO address(address_id,client_id, street, latitude, longitude) VALUES ('ST012',8, 'Logbessou iuc',  4.06, 9.6);

Prompt ******  Populating SERVICES table ....

INSERT INTO services(service_id, title, type, percentage) VALUES ('Casque_Beats_WS', 'Warranty', 'percentage', 0.10 );

Prompt ******  Populating WARRANTIES table ....

INSERT INTO Warranties(title, duration, service_id) VALUES ('Warranty on articles Casque_Beats', 30, 'Casque_Beats_WS');

Prompt ******  Populating ARTICLE table ....
INSERT INTO articles (article_name, article_description, group_id, class, price)
	VALUES ('Casque_Beats', 'Casque_Beats Gold Bluetooth',11,'small', 70000);
INSERT INTO article_service(article_id,service_id) 
	VALUES (article_id_seq.currval,'Casque_Beats_WS');
INSERT INTO list_price(price, article_id, client_id) VALUES(60000, article_id_seq.currval, client_id_seq.currval);



INSERT INTO articles (article_name, article_description, group_id, class, price)
	VALUES ('Casque_Beats', 'Casque_Beats White Bluetooth', 11,'small', 60500);
INSERT INTO article_service(article_id,service_id) 
	VALUES (article_id_seq.currval,'Casque_Beats_WS');
INSERT INTO list_price(price, article_id, client_id) VALUES(80000, article_id_seq.currval, client_id_seq.currval);
...
INSERT INTO articles (article_name, article_description, group_id, class, price)
	VALUES ('Casque_Beats', 'Casque_Beats Black Bluetooth', 11,'small', 60500);
	INSERT INTO article_service(article_id,service_id)
	VALUES (article_id_seq.currval,'Casque_Beats_WS');
INSERT INTO list_price(price, article_id, client_id) VALUES(80000, article_id_seq.currval, client_id_seq.currval);
