...
(
	...
	client_id NUMBER
	CONSTRAINT client_id_ord_nn NOT NULL,
...
Prompt ******  Creating Sound_purchase table ....

CREATE TABLE Sound_purchase
(
	sound_purchase_id VARCHAR2(25),
	title VARCHAR2(252),
	group_id NUMBER
);
...
CREATE TABLE Sound_purchase_client
(
	sound_purchase_id VARCHAR2(25),
	client_id NUMBER,
	amount NUMBER(10,2)
